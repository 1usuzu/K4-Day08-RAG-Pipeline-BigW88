...
* 🎤 **Review & Call-out (0:10 – 0:15 | 5 phút)**: Coach gọi ngẫu nhiên 1-2 đại diện nhóm demo màn hình setup venv và kiểm tra kết nối API Key.

---

### 🔹 Checkpoint 1: Thu Thập & Chuẩn Hoá Dữ Liệu — Task 1..3 (0:15 – 0:30 | 15 phút)
...
* 🎤 **Review & Call-out (0:30 – 0:35 | 5 phút)**: Coach gọi ngẫu nhiên 1 nhóm trình chiếu file Markdown đã convert & giải đáp lưu ý khi gặp trang web chặn bot (HTTP 403).
...
* 🎤 **Review & Call-out (1:00 – 1:05 | 5 phút)**: Coach gọi ngẫu nhiên 1 đại diện demo & so sánh sự khác biệt giữa kết quả Semantic Search vs Lexical BM25 Search.

---

### 🔹 Checkpoint 3: Reranking & Vectorless Fallback — Task 7..8 (1:05 – 1:20 | 15 phút)
...
* 🎤 **Review & Call-out (1:20 – 1:25 | 5 phút)**: Coach gọi ngẫu nhiên 1 nhóm trình bày logic RRF Rerank và giải thích bẫy điều kiện kích hoạt Fallback khi điểm Cosine $< 0.48$.

---

### 🔹 Checkpoint 4: Pipeline Hoàn Chỉnh & Generation — Task 9..10 (1:25 – 1:50 | 25 phút)
...
* 🎤 **Review & Call-out (1:50 – 2:00 | 10 phút)**: Coach tổng hợp & chốt mốc điểm cá nhân (50/50đ), hỗ trợ trực tiếp các học viên gặp lỗi chưa pass test suite.

---

### 🔹 Checkpoint 5: Bài Tập Nhóm — Chatbot UI & Đánh Giá RAGAS (2:00 – 2:40 | 40 phút)
...
* 🎤 **Review & Call-out (2:40 – 2:40 | 0 phút)**: Chuyển tiếp sang phần thuyết trình.

---

### 🔹 Checkpoint 6: Thuyết Trình Demo Live & Nộp Bài (2:40 – 4:00 | 80 phút)
